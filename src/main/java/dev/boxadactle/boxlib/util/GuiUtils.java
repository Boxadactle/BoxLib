...
public class GuiUtils {
    ...
    public static int getColorDecimal(String color) {
        ...
        switch (c) {
            case "dark_red": decimal = DARK_RED; break;
            case "red": decimal = RED; break;
            case "gold": decimal = GOLD; break;
            case "yellow": decimal = YELLOW; break;
            case "dark_green": decimal = DARK_GREEN; break;
            case "green": decimal = GREEN; break;
            case "aqua": decimal = AQUA; break;
            case "dark_aqua": decimal = DARK_AQUA; break;
            case "dark_blue": decimal = DARK_BLUE; break;
            case "blue": decimal = BLUE; break;
            case "light_purple": decimal = LIGHT_PURPLE; break;
            case "dark_purple": decimal = DARK_PURPLE; break;
            case "white": decimal = WHITE; break;
            case "gray": decimal = GRAY; break;
            case "dark_gray": decimal = DARK_GRAY; break;
            case "black": decimal = BLACK; break;
            default: decimal = WHITE;

...
public class ExampleConfigScreen extends BConfigScreen {
    ...
    protected Text getName() {
        return Text.translatable("boxlib.exampleconfigscreen");
    }
    ...
    protected void initFooter(int startX, int startY) {
        ...
        addDrawableChild(createHalfCancelButton(startX, startY, (b) -> {
        ...
        setWiki(Text.translatable("boxlib.wiki"), ModConstants.WIKI);
    }
    ...
    protected void initConfigButtons() {
        ...
        addConfigOption(new BCenteredLabel(Text.translatable("boxlib.anArgbField")));
        ...
        addConfigOption(new BWidgetContainer(
                new BCenteredLabel(Text.translatable("boxlib.aDouble")),
                new BCenteredLabel(Text.translatable("boxlib.aFloat"))
        ));
        ...
        addConfigOption(new BCenteredLabel(Text.translatable("boxlib.aHexColor")));
        ...
        addConfigOption(new BCenteredLabel(Text.translatable("boxlib.anInt")));
        ...
        addConfigOption(new BCenteredLabel(Text.translatable("boxlib.aString")));
